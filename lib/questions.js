const managerQuestions = [
    ...
    },
    {
        ...
        validate: (res) => {
            if (isNaN(res)) return 'Please enter a valid employee id.';
            else return true;
    },
    },
    {
    ...
    },
    {
        ...
        validate: (res) => {
            if (isNaN(res)) return 'Please enter an office number.';
            else return true;
        },
    },
            ...
            validate: (res) => {
                ...
                /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]
                    {0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-
                        ...
                        if (validEmail) return true;
                        if (!validEmail) return 'Please eneter a valid email address.';
            },
         },
         {
            type: 'input',
